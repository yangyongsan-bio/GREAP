...
============================-->
                ...
                <label>Annotated browse of SNP in ${browser_region}</label>
                <div id='igv-div'></div> 
    ...
    tracks: [
            {
                ...
                indexed: false,
                // delimiter: ' ',
                url: "http://www.liclab.net:8080/Greap_download/igvchr" + is19or38 + "/SNP/${snp_dataclass}/${browser_region?split(":")[0]}.bed",
            },
        ]
  };
