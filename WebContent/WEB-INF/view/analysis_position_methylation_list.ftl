...
============================-->
                ...
                <label>Annotated browse of Methylation in ${browser_region}</label>
                <div id='igv-div'></div>                
<script>
$('#example').DataTable({
    oLanguage: {
    ...
    columns:[
        ...
        {"data": 'string1'},
        {"data": function(data){
                 var string = "${methylation_dataclass}";
...
<script type="text/javascript">
  ...
  var options = {
    ...
    tracks: [
            {
                name: "${methylation_dataclass}",
                type: "annotation",
                format: "bed",
                indexed: false,
                // delimiter: ' ',
                url: "http://www.liclab.net:8080/Greap_download/igvchr" + is19or38 + "/Methylation/${methylation_dataclass}/${browser_region?split(":")[0]}.bed",
            },
        ]
  };
