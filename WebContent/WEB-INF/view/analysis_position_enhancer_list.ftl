...
============================-->
                <table id="example" class="table table-bordered" style="width:100%">
                    <thead>
                         <tr>
                            ...
                            <th>Enhancer end</th>
                            <th>Enhancer ID</th>
							<#if enhancer_dataclass?split("_")[0] == "ENdb">
                            <th>Set</th>
                            <th>Tissue Type</th>
                            <#else>
                            <th>Sample ID</th>
                ...
                <label>Annotated browse of Enhancer in ${browser_region}</label>
                <div id='igv-div'></div>   
...
<script type="text/javascript">
  ...
  var options = {
    ...
    tracks: [
            {
                name: "${enhancer_dataclass}",
                type: "annotation",
                format: "bed",
                indexed: false,
                // delimiter: ' ',
                url: "http://www.liclab.net:8080/Greap_download/igvchr" + is19or38 + "/Enhancer/${enhancer_dataclass}/${browser_region?split(":")[0]}.bed",
            },
        ]
  };
