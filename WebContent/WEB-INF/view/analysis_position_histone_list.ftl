...
============================-->
                ...
                <label>Annotated browse of Histone in ${browser_region}</label>
                <div id='igv-div'></div>                 
<script>
$('#example').DataTable({
    oLanguage: {
...
<script type="text/javascript">
  ...
  var options = {
    ...
    tracks: [
            {
                name: "${histone_dataclass}",
                type: "annotation",
                format: "bed",
                indexed: false,
                // delimiter: ' ',
                url: "http://www.liclab.net:8080/Greap_download/igvchr" + is19or38 + "/Histone/${histone_dataclass}/${browser_region?split(":")[0]}.bed",
            },
        ]
  };
