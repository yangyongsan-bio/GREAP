                                    ...
                                    <table id="example" class="table table-bordered" style="width:100%">
                                        <thead>
	                                        ...
	                                        <tr>
	                                            ...
	                                            <th>P_value <i data-toggle="tooltip" data-placement="left" class="glyphicon glyphicon-question-sign" title="P value."></i></th>
	                                            <th>-log10(P_value) <i data-toggle="tooltip" data-placement="left" class="glyphicon glyphicon-question-sign" title="The -log10 of P value."></i></th>
	                                        ...
	                                        <script>
	                                            ...
	                                            function format(set, id) {
													...
													let length = ${userLineLength};
													html += "<tr><td>Reference</td><td>Input</td>"
													if (length !== 3) {
														if (length >= 4) {
														    html += "<td>V4 <img src='${base.contextPath}/static/img/question.png'  data-toggle='tooltip'  title='Column 4 of user input' style='width: 12px;'></td>"
														}
														if (length >= 5) {
														    html += "<td>V5 <img src='${base.contextPath}/static/img/question.png'  data-toggle='tooltip'  title='Column 5 of user input' style='width: 12px;'></td>"
														}
														if (length >= 6) {
														    html += "<td>V6 <img src='${base.contextPath}/static/img/question.png'  data-toggle='tooltip'  title='Column 6 of user input' style='width: 12px;'></td>"
														}
														if (length >= 7) {
														    html += "<td>V7 <img src='${base.contextPath}/static/img/question.png'  data-toggle='tooltip'  title='Column 7 of user input' style='width: 12px;'></td>"
														}
														if (length >= 8) {
														    html += "<td>V8 <img src='${base.contextPath}/static/img/question.png'  data-toggle='tooltip'  title='Column 8 of user input' style='width: 12px;'></td>"
														}
														if (length >= 9) {
														    html += "<td>V9 <img src='${base.contextPath}/static/img/question.png'  data-toggle='tooltip'  title='Column 9 of user input' style='width: 12px;'></td>"
														}
														if (length >= 10) {
														    html += "<td>V10 <img src='${base.contextPath}/static/img/question.png'  data-toggle='tooltip'  title='Column 10 of user input' style='width: 12px;'></td>"
														}
														if (length >= 11) {
														    html += "<td>V11 <img src='${base.contextPath}/static/img/question.png'  data-toggle='tooltip'  title='Column 11 of user input' style='width: 12px;'></td>"
														}
														if (length >= 12) {
														    html += "<td>V12 <img src='${base.contextPath}/static/img/question.png'  data-toggle='tooltip'  title='Column 12 of user input' style='width: 12px;'></td>"
														}
													}
													html += "</tr></thead><tbody>"
												    $.ajax({
		                                        ...
		                                        let table = $('#example').DataTable({
												    ...
												    columns:[
												        ...
												        {"data": function(data){
												                return '<a href =\'/Greap/analysis/set_detail?grch='+"${genome}"+'&datatype='+"${class}"+'&subclass='+"${overlap_subset}"+'&set='+data.string1+'&count='+data.string7+'&port=0\' target="_blank">' + data.string1 + '</a>' ;
												            },
												        },
												        {"data": function(data){
												                return "${class}"
	                                        ...
	                                        <tr>
		                                        ...
		                                        <script>
												    $('#example').DataTable({
												        ...
												        columns:[
												            {"data": function(data){
															         return '<a href =\'/Greap/analysis/set_detail?grch='+"${genome}"+'&datatype='+"${class}"+'&subclass='+"${overlap_subset}"+'&set='+data.string7.replace(".bed","")+'&count='+parseInt(data.string8)+'&port=0'+'&overlap_num='+data.string9+'\' target="_blank">' + data.string7.replace(".bed","") + '</a>' ;
															      },
															},
												            {"data": function(data){
															         return "${class}"
