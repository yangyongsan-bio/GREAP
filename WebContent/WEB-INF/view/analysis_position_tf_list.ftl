...
============================-->
                ...
                <label>Annotated browse of TF in ${browser_region}</label>
                <div id='igv-div'></div>               
<script>
$('#example').DataTable({
    oLanguage: {
    ...
    tracks: [
            {
                ...
                indexed: false,
                // delimiter: ' ',
                url: "http://www.liclab.net:8080/Greap_download/igvchr" + is19or38 + "/TF/${tf_dataclass}/${browser_region?split(":")[0]}.bed",
            },
        ]
  };
