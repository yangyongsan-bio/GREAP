...
<head>
    ...
    <style type="text/css">
        ...
        .dataTables_length{margin-top:8px;}
            ...
            <form action="../analysis/position/Enhancer"  method="post" target="histoneiframe">
            <label>Select enhancer class</label>
            <select class="form-control" onchange="form.submit()" name="dataclass" style="width: 30%;margin-bottom: 10px;display: inline;">
                    <option value="ENdb" selected>ENdb</option>
                    <option value="SEdb" >SEdb</option>
            </select>
            <a href="/Greap/view/help#Enhancer" target="_blank"><img src="/Greap/static/img/question.png" style="width: 12px;margin-left: 2px;margin-top: -3px;"></a>
            </form>
            
            <iframe src="${base.contextPath}/analysis/position/Enhancer?dataclass=ENdb" frameborder="no"  name="histoneiframe" style="width:100%;height:650px;"></iframe>    
