...
<head>
    ...
    <style type="text/css">
        ...
        .dataTables_length{margin-top:8px;}
            ...
            <form action="../analysis/position/Methylation"  method="post" target="histoneiframe">
            <label>Select methylation class</label>
            <select class="form-control" onchange="form.submit()" name="dataclass" style="width: 30%;margin-bottom: 10px;display: inline;">
                    <option value="Hyper_10kb" selected>Hyper_10kb</option>
					<option value="Hyper_15kb" >Hyper_15kb</option>
					<option value="Hyper_20kb" >Hyper_20kb</option>
					<option value="Hypo_10kb" >Hypo_10kb</option>
					<option value="Hypo_15kb" >Hypo_15kb</option>
					<option value="Hypo_20kb" >Hypo_20kb</option>
            </select>
            <a href="/Greap/view/help#Methylation" target="_blank"><img src="/Greap/static/img/question.png" style="width: 12px;margin-left: 2px;margin-top: -3px;"></a>
            </form>
            
            <iframe src="${base.contextPath}/analysis/position/Methylation?dataclass=Hyper_10kb" frameborder="no"  name="histoneiframe" style="width:100%;height:650px;"></iframe>    
