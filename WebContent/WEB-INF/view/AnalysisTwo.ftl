...
<form action="../analysisTwo" method="post" enctype="multipart/form-data" style="margin-top:110px">
                ...
                <div class="row">
                    <div class="col-lg-12 ">
                        <div class="form-group">
                            ...
                            <br>
                            <label>PCR product size</label>
			                <div class="row">
	                            <input name="pcr_min" id="pcr_min" placeholder="Min" class="form-control" style="width: 23.3%; height: 30px; float: left; margin-left: 15px;">
	                            <p style="float: left;">&nbsp;-&nbsp;</p> 
	                            <input name="pcr_max" id="pcr_max" placeholder="Max" class="form-control" style="width: 23.3%; height: 30px; float: left;">
                            </div>
                            <label>Primer size</label>
			                <div class="row">
	                            <input name="primer_min" id="primer_min" placeholder="Min" class="form-control" style="width: 23.3%; height: 30px; float: left; margin-left: 15px;">
	                            <p style="float: left;">&nbsp;-&nbsp;</p> 
	                            <input name="primer_max" id="primer_max" placeholder="Max" class="form-control" style="width: 23.3%; height: 30px; float: left;">
                            </div>
